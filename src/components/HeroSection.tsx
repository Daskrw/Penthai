        ...
        >
          ...
          >
            <Button 
              asChild 
              size="lg" 
              className="bg-primary hover:bg-primary-hover text-primary-foreground shadow-thai-lg group text-lg px-8 py-6"
            >
              <Link to="/shop">
                เลือกซื้อสินค้า
          ...
          {/* Trust Badges */}
          <motion.div 
            className="mt-12 flex flex-wrap gap-6 text-base"
            variants={containerVariants}
            initial="hidden"
            animate={isLoaded ? "visible" : "hidden"}
